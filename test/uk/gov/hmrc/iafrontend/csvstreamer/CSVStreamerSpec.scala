...
import uk.gov.hmrc.iafrontend.testsupport.ResourceReader._

import scala.concurrent.duration.Duration
import scala.concurrent.{Await, Future}

class CSVStreamerSpec extends ITSpec {
  ...
  "CSVStreamer should flow should send data to ia in batchs" in {
  ...
  "CSVStreamer should flow should call ia everythime there is a batch size met in" in {
