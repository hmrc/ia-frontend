...
trait ITSpec
  ...
  override def fakeApplication(): Application = new GuiceApplicationBuilder()
    ...
    .configure("microservice.services.lock.port" -> WireMockSupport.port, "microservice.services.ia.port" -> WireMockSupport.port, "microservice.services.auth.port" -> WireMockSupport.port).build()
